import { BotIcon, EyeIcon, LoaderIcon, SendIcon, UserIcon } from "lucide-react";
import type { Message, Project ,Version } from "../types"
import { Link } from "react-router-dom";
import { useEffect, useRef, useState} from "react";

interface SideparProps {
    isMenuOpen : boolean,
    project : Project,
...
function Sidebar({isMenuOpen,project,setProject,isGenerating,setIsGenerating}: SideparProps) {
    ...
    ${isMenuOpen ? 'max-sm:w-0 overflow-hidden':"w-full"}`}>
        <div className=" flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-3 flex flex-col gap-4">
                ...
                {/* Chat should be scroll to bottom */}
                <div ref={messageRef}/>
            </div>
            ...
            <form onSubmit={handleRevision} className="m-3 relative">
                <div className="flex items-center gap-2">
                    ...
                    <button 
                        ...
                        >
                        {isGenerating 
                        ? <LoaderIcon className="size-7 p-1.5 animate-spin text-white" />
                        : <SendIcon className="size-8 p-1.5 text-white" />
                        }
                    </button>
